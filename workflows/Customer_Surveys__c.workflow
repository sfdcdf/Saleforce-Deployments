<?xml version="1.0" encoding="utf-8"?><Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <description>General , Status defaults to "new" when record is created, LH specific</description>
    ...
    <rules>
        ...
        <description>ti's a general workflow</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <description>LH Specific . Email sent to Crystal Bellew when an Exit Survey is returned with "Poor Customer Service" selected as reason for cancellation.</description>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
